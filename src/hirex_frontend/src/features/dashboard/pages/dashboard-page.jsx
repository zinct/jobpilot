    ...
    <>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <motion.div
          ...
          className="col-span-full rounded-xl border border-white/10 bg-gradient-to-b from-gray-900 to-black p-6"
        >
              ...
              <div className="relative h-12 w-12">
                <svg className="h-12 w-12 -rotate-90 transform">
                  ...
                  <circle
                    ...
                    strokeDashoffset="31.4" // 25% complete
                    strokeLinecap="round"
                  />
                  <defs>
                    <linearGradient
        ...
        >
          ...
          <p className="mb-4 text-gray-400">
            Create professional resumes tailored to specific job opportunities.
          </p>
        ...
        >
          <div className="mb-4 flex items-center justify-between">
            ...
            <span className="rounded-full bg-violet-400/20 px-2 py-1 text-xs text-violet-400">
              12 New
            </span>
          </div>
          <p className="mb-4 text-gray-400">
        ...
        >
          ...
          <p className="mb-4 text-gray-400">
            Recommended courses to enhance your skills and career prospects.
          </p>
          <Button className="w-full justify-between bg-gradient-to-r from-cyan-400 to-violet-500 text-black hover:from-cyan-500 hover:to-violet-600">
            Explore Courses
            <ArrowRight className="h-4 w-4" />
        ...
        <motion.div
          ...
          className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm lg:col-span-2"
        >
          <div className="mb-4 flex items-center justify-between">
            <h3 className="text-lg font-medium">Recent Job Matches</h3>
            <Button
              variant="ghost"
              className="text-sm text-cyan-400 hover:bg-white/5 hover:text-cyan-300"
            >
              View All
          ...
          <div className="space-y-4">
            {recentJobs.map((job, index) => (
              <div
                key={index}
                className="flex flex-col justify-between gap-2 rounded-lg border border-white/10 bg-white/5 p-4 sm:flex-row sm:items-center"
              >
                <div>
        ...
        >
          <div className="mb-4 flex items-center justify-between">
            ...
            <Button
              variant="outline"
              size="sm"
              className="h-8 gap-1 border-white/10 text-xs hover:bg-white/10"
            >
