...
export default function Register() {
  ...
  const totalSteps = 11; // Intro + 3 Personal Data steps + 7 Career Preference questions
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      ...
      setIsLoading(false);
      // For demo purposes, we'll just keep the loading state active
    }, 3000);
  };
            ...
            <div className="mx-auto w-full max-w-xl rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="space-y-6">
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-400">
                                Basic details about yourself and your background
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                        <p className="text-sm text-gray-300">
                          ...
                          personalized job recommendations. You can update your
                          preferences anytime from your profile settings.
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {/* Career Preferences Forms (Steps 4-10) */}
