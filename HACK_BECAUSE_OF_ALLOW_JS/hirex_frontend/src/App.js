...
import { ArrowRight, CheckCircle2, BrainCircuit, BookOpen, MessageSquare, FileText, Wallet, } from "lucide-react";
...
function App() {
    return (<>
      <div className="min-h-screen bg-black text-white">
        ...
        <header className="fixed top-0 z-50 w-full border-b border-white/10 bg-black/50 backdrop-blur-xl">
          <div className="container flex h-16 items-center justify-between px-4">
            ...
            <div className="flex items-center">
              <Button variant="outline" className="hover:border-cyan-400 hover:text-cyan-400 bg-cyan-400/10 text-cyan-300">
                Get Started
              </Button>
            </div>
          </div>
        ...
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden pt-16">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <svg className="absolute h-full w-full" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Top Curves */}
              <motion.path initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 1 }} transition={{
            duration: 2,
            ease: "easeInOut",
            repeat: Number.POSITIVE_INFINITY,
            repeatType: "loop",
            repeatDelay: 1,
        }} d="M 100 100 Q 300 0 500 100 T 900 100" fill="none" stroke="url(#grad1)" strokeWidth="1"/>
              <motion.path initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 1 }} transition={{
            duration: 2,
            ease: "easeInOut",
            repeat: Number.POSITIVE_INFINITY,
            ...
            repeatDelay: 1,
            delay: 0.5,
        }} d="M 0 200 Q 200 100 400 200 T 800 200" fill="none" stroke="url(#grad2)" strokeWidth="1"/>
              {/* Bottom Curves */}
              <motion.path initial={{ pathLength: 0, opacity: 0 }} animate={{ pathLength: 1, opacity: 1 }} transition={{
            duration: 2,
            ease: "easeInOut",
            ...
            repeatDelay: 1,
            delay: 1,
        }} d="M 100 600 Q 300 500 500 600 T 900 600" fill="none" stroke="url(#grad1)" strokeWidth="1"/>
            </svg>

            {/* Straight Lines */}
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }} className="absolute inset-0">
              {[...Array(3)].map((_, i) => (<motion.div key={i} initial={{ x: "100%", opacity: 0 }} animate={{
                x: "-100%",
                opacity: [0, 0.7, 0.7, 0],
            }} transition={{
                duration: 2.5,
                ...
                repeatType: "loop",
                ease: "linear",
            }} className="absolute right-0" style={{
                top: `${15 + i * 10}%`,
                height: "1px",
                width: "100%",
          ...
          <div className="container relative z-[3] px-4">
                        ...
                        <div className="space-y-3">
                          <div className="rounded-md bg-white/5 p-3">
                            <div className="flex justify-between">
                              ...
                              <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1, 1, 0] }} transition={{
            duration: 2,
            repeat: Infinity,
            repeatDelay: 3,
            ...
            "Cloud",
            "AI/ML",
        ].map((skill, index) => (<motion.span key={index} initial={{ opacity: 0.7 }} animate={{
                opacity: index === 0 || index === 4
                    ? [0.7, 1, 0.7]
                    : 0.7,
            }} transition={{
                duration: 2,
                repeat: Infinity,
                repeatDelay: 1,
            }} className={`rounded-full px-3 py-1 text-xs ${index === 0 || index === 4
                ...
                : "bg-white/10 text-gray-300"}`}>
                    ...
                    {/* AI Scanning Effect */}
                    <motion.div initial={{ top: 0 }} animate={{ top: "100%" }} transition={{
            duration: 2,
            repeat: Infinity,
            repeatType: "loop",
            repeatDelay: 5,
        }} className="absolute left-0 right-0 h-1 bg-gradient-to-r from-transparent via-cyan-400 to-transparent" style={{ opacity: 0.7 }}/>
                  </div>
        ...
        ].map((feature, index) => (<div key={index} className="flex items-center space-x-3">
